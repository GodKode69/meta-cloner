...
async function start() {
  ...
  // Once the client is ready, show the command menu
  client.once("ready", async () => {
    ...
    // Based on the selection, prompt for additional parameters
    if (command === "cloneguild") {
      ...
      // Attempt to fetch and display the source server's name
